package com.android.mvvm.glide
 ...
 */
@GlideModule
class KtAppGlideModule : AppGlideModule() {
  ...
  override fun applyOptions(context: Context,builder: GlideBuilder) {
    ...
    val diskCache: DiskCache.Factory = if (checkSelfPermission(context)) {
